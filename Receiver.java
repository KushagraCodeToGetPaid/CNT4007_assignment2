...
public class Receiver {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            System.out.println("Usage: java Receiver <Network IP address> <port>");
            System.exit(1);
        }
        ...
        while (!endOfMessage) {
            ...
            ackData[1] = (byte) 0;
            DatagramPacket ackPacket = new DatagramPacket(ackData, ackData.length, InetAddress.getByName(networkIPAddress), receivePacket.getPort());
